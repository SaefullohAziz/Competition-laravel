	...
	<div class="col-12">
		...
		<div class="card card-primary">
			<div class="card-header">
				<!-- if (auth()->guard('admin')->user()->can('create juri')) -->
					<a href="{{ route('admin.juri.create') }}" class="btn btn-icon btn-success" title="{{ __('Create') }}"><i class="fa fa-plus"></i></a>
				<!-- endif -->
